...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/03/08 12:24:10 by roddavid          #+#    #+#             */
/*   Updated: 2018/04/18 14:16:23 by roddavid         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_pixel_tricorn(t_data *data)
{
	if (data->i < data->imax)
...
void	ft_calc_tricorn(t_data *data, int thread_id, int padding)
{
	while (data->y < WIN_H)
	{
...
void	*ft_tricorn(void *param)
{
	...
	ft_calc_tricorn(data, thread_id, padding);
	pthread_exit(NULL);
	return (NULL);
}
