...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/02/27 15:14:17 by roddavid          #+#    #+#             */
/*   Updated: 2018/04/18 14:11:17 by roddavid         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_pixel_mandelbrot(t_data *data)
{
	if (data->i < data->imax)
...
void	ft_calc_mandelbrot(t_data *data, int thread_id, int padding)
{
	while (data->y < WIN_H)
	{
...
void	*ft_mandelbrot(void *param)
{
	...
	ft_calc_mandelbrot(data, thread_id, padding);
	pthread_exit(NULL);
	return (NULL);
}
